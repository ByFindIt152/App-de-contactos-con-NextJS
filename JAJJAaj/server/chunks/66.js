...
const helper_1 = __webpack_require__(7133);
const types_1 = __webpack_require__(4147);
...
const resolveFetch = (customFetch)=>{
    ...
    if (customFetch) {
        ...
        _fetch = (...args)=>Promise.resolve().then(()=>__importStar(__webpack_require__(212))).then(({ default: fetch1 })=>fetch1(...args));
    } else {
        _fetch = fetch;
    }
...
var FunctionsClient_1 = __webpack_require__(3761);
...
var types_1 = __webpack_require__(4147);
...
const helpers_1 = __webpack_require__(1431);
const errors_1 = __webpack_require__(574);
...
const GoTrueAdminApi_1 = __importDefault(__webpack_require__(9431));
const constants_1 = __webpack_require__(5866);
const errors_1 = __webpack_require__(574);
const fetch_1 = __webpack_require__(4955);
const helpers_1 = __webpack_require__(1431);
const local_storage_1 = __importDefault(__webpack_require__(6201));
const polyfills_1 = __webpack_require__(2461);
const version_1 = __webpack_require__(1876);
const locks_1 = __webpack_require__(9873);
...
const GoTrueClient_1 = __importDefault(__webpack_require__(3972));
exports.GoTrueClient = GoTrueClient_1.default;
__exportStar(__webpack_require__(8530), exports);
__exportStar(__webpack_require__(574), exports);
var locks_1 = __webpack_require__(9873);
...
exports.version = "2.51.0"; //# sourceMappingURL=version.js.map
...
// @ts-ignore
const node_fetch_1 = __importDefault(__webpack_require__(212));
...
const PostgrestQueryBuilder_1 = __importDefault(__webpack_require__(180));
const PostgrestFilterBuilder_1 = __importDefault(__webpack_require__(3374));
...
const PostgrestTransformBuilder_1 = __importDefault(__webpack_require__(5));
...
const PostgrestBuilder_1 = __importDefault(__webpack_require__(1162));
...
const version_1 = __webpack_require__(1341);
exports.DEFAULT_HEADERS = {
...
var PostgrestClient_1 = __webpack_require__(4468);
...
var PostgrestQueryBuilder_1 = __webpack_require__(180);
...
var PostgrestFilterBuilder_1 = __webpack_require__(3374);
...
var PostgrestTransformBuilder_1 = __webpack_require__(5);
...
var PostgrestBuilder_1 = __webpack_require__(1162);
...
const constants_1 = __webpack_require__(5450);
const push_1 = __importDefault(__webpack_require__(7240));
const timer_1 = __importDefault(__webpack_require__(9864));
const RealtimePresence_1 = __importDefault(__webpack_require__(6784));
const Transformers = __importStar(__webpack_require__(7924));
...
const websocket_1 = __webpack_require__(2740);
const constants_1 = __webpack_require__(5450);
const timer_1 = __importDefault(__webpack_require__(9864));
const serializer_1 = __importDefault(__webpack_require__(4928));
const RealtimeChannel_1 = __importDefault(__webpack_require__(1735));
const noop = ()=>{};
...
const RealtimeClient_1 = __importDefault(__webpack_require__(5017));
exports.RealtimeClient = RealtimeClient_1.default;
const RealtimeChannel_1 = __importStar(__webpack_require__(1735));
...
const RealtimePresence_1 = __importStar(__webpack_require__(6784));
...
const version_1 = __webpack_require__(518);
exports.DEFAULT_HEADERS = {
...
exports.version = void 0;
exports.version = "2.7.4"; //# sourceMappingURL=version.js.map
...
const StorageFileApi_1 = __importDefault(__webpack_require__(5191));
const StorageBucketApi_1 = __importDefault(__webpack_require__(4954));
...
exports.StorageClient = void 0;
var StorageClient_1 = __webpack_require__(6934);
...
__exportStar(__webpack_require__(4321), exports);
__exportStar(__webpack_require__(2739), exports); //# sourceMappingURL=index.js.map
...
exports.DEFAULT_HEADERS = void 0;
const version_1 = __webpack_require__(9995);
exports.DEFAULT_HEADERS = {
...
const errors_1 = __webpack_require__(2739);
const helpers_1 = __webpack_require__(4693);
const _getErrorMessage = (err)=>err.msg || err.message || err.error_description || err.error || JSON.stringify(err);
...
const resolveResponse = ()=>__awaiter(void 0, void 0, void 0, function*() {
        if (typeof Response === "undefined") {
            // @ts-ignore
            return (yield Promise.resolve().then(()=>__importStar(__webpack_require__(212)))).Response;
        }
        return Response;
    });
...
const constants_1 = __webpack_require__(7410);
const errors_1 = __webpack_require__(2739);
const fetch_1 = __webpack_require__(9637);
const helpers_1 = __webpack_require__(4693);
...
const functions_js_1 = __webpack_require__(6405);
const postgrest_js_1 = __webpack_require__(5018);
const realtime_js_1 = __webpack_require__(7431);
const storage_js_1 = __webpack_require__(7668);
const constants_1 = __webpack_require__(7382);
const fetch_1 = __webpack_require__(3502);
const helpers_1 = __webpack_require__(6734);
...
const SupabaseClient_1 = __importDefault(__webpack_require__(4426));
__exportStar(__webpack_require__(4868), exports);
var functions_js_1 = __webpack_require__(6405);
Object.defineProperty(exports, "FunctionsHttpError", ({
    enumerable: true,
    get: function() {
...
__exportStar(__webpack_require__(7431), exports);
var SupabaseClient_2 = __webpack_require__(4426);
...
const gotrue_js_1 = __webpack_require__(4868);
...
exports.DEFAULT_HEADERS = void 0;
// constants.ts
const version_1 = __webpack_require__(9895);
exports.DEFAULT_HEADERS = {
...
// @ts-ignore
const node_fetch_1 = __importStar(__webpack_require__(212));
const resolveFetch = (customFetch)=>{
    let _fetch;
    if (customFetch) {
        _fetch = customFetch;
...
exports.version = void 0;
exports.version = "2.33.2"; //# sourceMappingURL=version.js.map
...
if (typeof process.addon === "function") {
    ...
    module.exports = __webpack_require__(9952);
}
...
var mappingTable = __webpack_require__(542);
 ...
 */ 
var isTypedArray = (__webpack_require__(2175).strict);
 ...
 *  limitations under the License.
 ***********************************************************************/ 
var WebSocketClient = __webpack_require__(7007);
var toBuffer = __webpack_require__(3767);
var yaeti = __webpack_require__(5946);
const CONNECTING = 0;
const OPEN = 1;
const CLOSING = 2;
const CLOSED = 3;
 ...
 *  limitations under the License.
 ***********************************************************************/ 
var utils = __webpack_require__(4303);
...
var WebSocketConnection = __webpack_require__(6169);
...
var utils = __webpack_require__(4303);
var EventEmitter = (__webpack_require__(2361).EventEmitter);
var WebSocketFrame = __webpack_require__(1804);
var BufferList = __webpack_require__(6580);
var isValidUTF8 = __webpack_require__(5325);
var bufferAllocUnsafe = utils.bufferAllocUnsafe;
 ...
 *  limitations under the License.
 ***********************************************************************/ 
var bufferUtil = __webpack_require__(4656);
var bufferAllocUnsafe = (__webpack_require__(4303).bufferAllocUnsafe);
 ...
 *  limitations under the License.
 ***********************************************************************/ 
var extend = (__webpack_require__(4303).extend);
var util = __webpack_require__(3837);
var EventEmitter = (__webpack_require__(2361).EventEmitter);
var WebSocketRouterRequest = __webpack_require__(6299);
...
var utils = __webpack_require__(4303);
var util = __webpack_require__(3837);
var debug = __webpack_require__(1741)("websocket:server");
var EventEmitter = (__webpack_require__(2361).EventEmitter);
var WebSocketRequest = __webpack_require__(8701);
...
exports.BufferingLogger = function createBufferingLogger(identifier, uniqueID) {
    var logFunction = __webpack_require__(1741)(identifier);
...
module.exports = {
    "server": __webpack_require__(2670),
    "client": __webpack_require__(7007),
    "router": __webpack_require__(2278),
    "frame": __webpack_require__(1804),
    "request": __webpack_require__(8701),
    "connection": __webpack_require__(6169),
    "w3cwebsocket": __webpack_require__(5457),
    "deprecation": __webpack_require__(9932),
    "version": __webpack_require__(1569)
};
 ...
 */ 
exports = module.exports = __webpack_require__(5039);
exports.log = log;
...
if (typeof process !== "undefined" && process.type === "renderer") {
    ...
    module.exports = __webpack_require__(2965);
}
...
const usm = __webpack_require__(7727);
...
const conversions = __webpack_require__(1254);
const utils = __webpack_require__(9080);
const Impl = __webpack_require__(7497);
...
exports.URL = __webpack_require__(7112)["interface"];
exports.serializeURL = __webpack_require__(7727).serializeURL;
exports.serializeURLOrigin = __webpack_require__(7727).serializeURLOrigin;
exports.basicURLParse = __webpack_require__(7727).basicURLParse;
exports.setTheUsername = __webpack_require__(7727).setTheUsername;
exports.setThePassword = __webpack_require__(7727).setThePassword;
exports.serializeHost = __webpack_require__(7727).serializeHost;
exports.serializeInteger = __webpack_require__(7727).serializeInteger;
exports.parseURL = __webpack_require__(7727).parseURL;
...
const tr46 = __webpack_require__(7932);
...
module.exports = {
    EventTarget: __webpack_require__(3716),
